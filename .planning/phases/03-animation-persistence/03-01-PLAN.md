...
Verify key_links are wired: run `grep -E '(PetTraitsSchema\.safeParse|generatePetTraits)' src/lib/traits/migration.ts` and confirm both patterns appear in output.
  </verify>
  <done>
